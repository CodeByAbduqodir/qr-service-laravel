...
<body>
    <div class="container">
        <div class="card animate__animated animate__fadeIn" style="max-width: 600px; margin: 0 auto; padding: 20px; background: rgba(255, 255, 255, 0.1); border-radius: 15px; backdrop-filter: blur(10px);">
            <h2 class="text-center mb-4">QR Code Generated</h2>
            <div class="card-body text-center animate__animated animate__zoomIn" style="animation-delay: 0.3s;">
                <!-- <p>QR Code URL: <a href="{{ $qr_url }}" class="text-info">{{ $qr_url }}</a></p> -->
                <img src="{{ $qr_url }}" alt="QR Code" class="img-fluid mt-3" style="max-width: 250px; border: 2px solid #fff; border-radius: 10px;">
